 ...
 */
public class ConditionalMapper extends JDBCMapper
{
    protected static final Logger log = LoggerFactory.getLogger( ConditionalMapper.class );
    ...
    protected Mapper existsMapper;
    protected Mapper noneMapper;
    ...
    public Response handle(Request request)
    {
        ...
        {
            log.error( "CONDITIONAL Mapper ERROR on conditionQuery = " + conditionQuery + " \n request = " + request );
    ...
    public Mapper getExistsMapper() {
        return existsMapper;
    }

    public void setExistsMapper(Mapper existsMapper) {
        this.existsMapper = existsMapper;
    }

    public Mapper getNoneMapper() {
        return noneMapper;
    }

    public void setNoneMapper(Mapper noneMapper) {
